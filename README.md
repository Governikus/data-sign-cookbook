...
| example.signProvider       | Your chosen provider, e.g. "G+D Netcetera" `NETCETERA` or "D-Trust" `DTRUST`                                                                                                                                              |
| example.sealProvider       | Your chosen provider, e.g. "A-Trust" `ATRUST`, "G+D Netcetera" `NETCETERA`, "D-Trust" `DTRUST` or "Smartcards" `SMARTCARDS`                                                                                               |
...
| example.timestampProvider  | Your chosen timestamp provider, e.g. "A-Trust" `ATRUST`, ""G+D Netcetera"" `NETCETERA`, "D-Trust" `DTRUST`, "Telesec" `TELESEC`. "Utimaco" `UTIMACO` or selfsigned `SELFSIGNED`. Only required for to be signed examples. |
