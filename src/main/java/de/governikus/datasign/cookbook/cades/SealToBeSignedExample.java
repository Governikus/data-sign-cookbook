...
public class SealToBeSignedExample extends AbstractExample {
    ...
    public void runExample() throws Exception {
        ...
        var transaction = send(
                POST("/seal/to-be-signed/transactions",
                        new SealToBeSignedTransactionRequest(
                                sealId,
                                new SignatureParameter(SignatureNiveau.QUALIFIED, SignatureLevel.B_T, HashAlgorithm.SHA_256),
        ...
        System.out.println("sample.pdf is now sealed and the detached signature is written to disk as sample_sealed.docx.p7s");
    }
